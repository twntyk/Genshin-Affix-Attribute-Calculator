...
function updateMetaTags(lang) {
    const metaTags = {
        ...
        "ru": {
            ...
            "description": "Этот инструмент поможет вам рассчитать шансы выпадения 4-го аффикса/доп-стата на артефакте в Genshin Impact."
        },
        "uk": {
            "keywords": "Genshin Impact, калькулятор артефактів, ймовірність афіксів, шанс характеристик, артефакти Genshin",
            "description": "Цей інструмент допоможе вам розрахувати шанси випадання 4-го афікса/доп-стата на артефакті Genshin Impact."
        }
    };
